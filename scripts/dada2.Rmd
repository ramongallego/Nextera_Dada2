...
```{r}
# Output files
  conv_file <- file.path(params$output.folder,"hash_key.csv")
  conv_file.fasta <- file.path(params$output.folder,"hash_key.fasta")
  
  ASV_file <-  file.path(params$output.folder,"ASV_table.csv")
