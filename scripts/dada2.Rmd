...
params:
  folder: 
    value: /Users/ramon.gallegosimon/Projects/Hook_and_line/Miseq.data/HL_Data
  hash: TRUE
  trimming.length.Read1: 250
  trimming.length.Read2: 250
  metadata: metadata.for.16S.csv
...
output.dada2 <- read_rds(path = "output.halfway.rds")
