...
output.dada2 <- read_rds("/Users/ramon.gallegosimon/Projects/eDNA-Hake/Data/Pipeline_output/Run2/noprimers/outputs_noQ_F267_R53/output.halfway.rds")
output.dada2 %>% 
  mutate( mergers = pmap(.l = list(a = dadaF1, b = derepF1, c = dadaR1, d = derepR1),                 # merge things
                         .f =  function(a,b,c,d){mergePairs(a,b,c,d, minOverlap = 10, maxMismatch = 2)})) -> output.dada2
# if ( params$keep.mid.files==TRUE){
# write_rds(output.dada2, path = "output.halfway.rds")}
